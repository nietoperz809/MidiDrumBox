...
/**
 * A <code>sermidi.SerShortMessage</code> contains a MIDI message that has at most
 ...
 * and meta-events.  The <code>sermidi.SerShortMessage</code> class provides methods
 * for getting and setting the contents of the MIDI message.
 * <p>
 * A number of <code>sermidi.SerShortMessage</code> methods have integer parameters by which
 ...
 * you can often use the corresponding fields of <code>sermidi.SerShortMessage</code>, such as
...
public class SerShortMessage extends SerMidMessage implements Serializable
{
    ...
    // Instance variables
        ...
        /**
         * Constructs a new <code>sermidi.SerShortMessage</code>.  The
    ...
    /**
     * Constructs a new {@code sermidi.SerShortMessage} which represents a MIDI
     ...
     * @since 1.7
     */
    public SerShortMessage(int status) throws InvalidMidiDataException
    {
        super(null);
    ...
    /**
     * Constructs a new {@code sermidi.SerShortMessage} which represents a MIDI message
     ...
     * @since 1.7
     */
    public SerShortMessage(int status, int data1, int data2)
    ...
    /**
     * Constructs a new {@code sermidi.SerShortMessage} which represents a channel
     ...
     * @since 1.7
     */
    public SerShortMessage(int command, int channel, int data1, int data2)
            //throws InvalidMidiDataException
    {
        super(null);
    ...
    public ShortMessage toShortMessage()
    {
        try
        {
            return new ShortMessage(getCommand(),getChannel(), getData1(), getData2());
        }
    ...
    /**
     * Constructs a new <code>sermidi.SerShortMessage</code>.
    ...
    protected SerShortMessage(byte[] data) {
            ...
            //throws InvalidMidiDataException
    {
        ...
        // set the length
        length = dataLength + 1;
        // re-allocate array if sermidi.SerShortMessage(byte[]) constructor gave array with fewer elements
...
//        }
    ...
    public Object clone() {
        ...
        SerShortMessage msg = new SerShortMessage(newData);
        return msg;
    }
